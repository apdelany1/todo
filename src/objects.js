...
const complete0 = toDoItem("Win lottery", "You need money!", "04-03-2021", "High");
const complete1 = toDoItem("Get Suit From Cleaners", "You need it for the wedding", "09-13-2023", "low");
const complete2 = toDoItem("Pump basketball", "Cant ball with flat ball", "01-07-2023", "Medium");
...
export { toDoItem, tasks, complete }
